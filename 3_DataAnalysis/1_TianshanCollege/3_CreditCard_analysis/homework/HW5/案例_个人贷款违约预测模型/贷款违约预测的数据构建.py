...
# In[2]:
os.chdir(r"E:\soft\Anaconda\Anaconda_Python3.6_code\data_analysis\TianshanCollege\3_CreditCard_analysis\homework\HW5\案例_个人贷款违约预测模型")
loanfile = os.listdir()
createVar = locals()
for i in loanfile:
    if i.endswith("csv"):        
...
data2.head()
#data2.to_csv(r"C:\\Users\\dell\\Desktop\\123123\\data2.csv")
...
data3.head()
#data3.to_csv(r"C:\\Users\\dell\\Desktop\\123123\\data3.csv")
