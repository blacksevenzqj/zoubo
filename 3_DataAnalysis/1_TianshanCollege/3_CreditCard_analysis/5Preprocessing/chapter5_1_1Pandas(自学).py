...
sample = pd.read_csv(r'E:\soft\Anaconda\Anaconda_Python3.6_code\data_analysis\TianshanCollege\3_CreditCard_analysis\5Preprocessing\sample.csv', encoding='gbk')
sample.head()
