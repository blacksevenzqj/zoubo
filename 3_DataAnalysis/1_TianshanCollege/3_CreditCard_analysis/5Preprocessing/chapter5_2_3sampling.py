...
#%%
import pandas as pd
clients = pd.read_csv(r'E:\soft\Anaconda\Anaconda_Python3.6_code\data_analysis\1_TianshanCollege\3_CreditCard_analysis\5Preprocessing\clients.csv',encoding = 'gbk')
