...
M_rank = M_trans.sort_values('spe_ratio',ascending=False, na_position='last')[0:100]
M_rank['spe_ratio_group'] = pd.qcut( M_rank['spe_ratio'], 4)
print(M_rank['spe_ratio_group'].value_counts())
