...
os.chdir(r"E:\soft\Anaconda\Anaconda_Python3.6_code\data_analysis\TianshanCollege\4_HousingPrice_analysis\7linearmodel")
...
exp.plot('Pred', 'resid',kind='scatter') # Pred = β*Income
ana1.summary()
