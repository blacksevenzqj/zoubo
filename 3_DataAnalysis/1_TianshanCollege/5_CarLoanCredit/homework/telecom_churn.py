...
os.chdir(r"E:\soft\Anaconda\Anaconda_Python3.6_code\data_analysis\TianshanCollege\5_CarLoanCredit\homework")
...
candidates = ['churn','duration','AGE','edu_class','posTrend','nrProm','curPlan','planChange','incomeCode','feton','peakMinAv','peakMinDiff','call_10086']
...
candidates = ['duration','AGE','edu_class','posTrend','nrProm','curPlan','planChange','incomeCode','feton','peakMinAv','peakMinDiff','call_10086']
