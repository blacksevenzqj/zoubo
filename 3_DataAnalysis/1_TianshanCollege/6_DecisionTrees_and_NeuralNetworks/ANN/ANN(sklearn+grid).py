...
os.chdir(r"E:\soft\Anaconda\Anaconda_Python3.6_code\data_analysis\TianshanCollege\6_DecisionTrees_and_NeuralNetworks\ANN")
...
data = churn.iloc[:, 2:]
target = churn['churn']
train_data, test_data, train_target, test_target = train_test_split(data, target, test_size=0.4, train_size=0.6, random_state=123) 

# 极差标准化
# In[4]:
from sklearn.preprocessing import MinMaxScaler

scaler = MinMaxScaler() # 极大极小值标准化
