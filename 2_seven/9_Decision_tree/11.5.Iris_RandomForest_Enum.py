...
if __name__ == "__main__":
    ...
    for i, pair in enumerate(feature_pairs):
        ...
        result1 = (y_train_pred == y_train)  # True则预测正确，False则预测错误
        err1 = 1 - np.mean(result1)
        print('\t训练集误差率：%.4f%%' % (100 * err1))
        print('\t测试集准确率: %.4f%%' % (100 * acc_test))
        result2 = (y_test_pred == y_test)  # True则预测正确，False则预测错误
        ...
        plt.title(u'分类：' + iris_feature[pair[0]] + "x1 : " + iris_feature[pair[1]] + "x2")
