...
if __name__ == '__main__':
    ...
    if os.path.exists(model_file+'sss'):
        ...
        print(y_train.mean())
        print(y_valid.mean())
        model = RandomForestClassifier(criterion='gini', max_depth=10, min_samples_split=5)
        print('value_counts = \n', pd.value_counts(y_train))
        # model = LogisticRegression(penalty='l2', C=10, class_weight={0:1, 1:3})
